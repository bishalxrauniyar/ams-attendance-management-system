...
<body>
  <div class="container">
    ...
    if (isset($_GET['batch_id']) && isset($_GET['dep_id'])) {
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo "<li>";
          echo "<h2><a href='../semsubject/sem_subject_list.php?semester_id=" . $row['semester_id'] . "&batch_id=" . $batch_id . "'>" . $row['semester_name'] . "</a></h2>";
          echo "<div class='button-container'>";
          echo "<a class='button' href='edit_semester.php?semester_id=" . $row['semester_id'] . "'>Edit</a>";
          echo "<a class='button' href='delete_semester.php?semester_id=" . $row['semester_id'] . "'>Delete</a>";
        ...
        // Add button to add a new semester
        echo "<div class='button-container'>";
        echo "<a class='button' href='add_semester.php?batch_id=" . $batch_id . "&dep_id=" . $depId . "'>Add Semester</a>";
        echo "</div>";
      } else {
        echo "<h1>No Semesters Found</h1>";
        echo "<div class='button-container'>";
        echo "<a class='button' href='add_semester.php?batch_id=" . $batch_id . "'>Add Semester</a>";
        echo "</div>";
      }
    }
